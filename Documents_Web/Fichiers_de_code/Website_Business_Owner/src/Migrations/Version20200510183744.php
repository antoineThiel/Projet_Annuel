 ...
 */
final class Version20200510183744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE turnover (id INT AUTO_INCREMENT NOT NULL, franchisee_id INT NOT NULL, amount_turnover DOUBLE PRECISION NOT NULL, date_turnover DATETIME NOT NULL, is_new TINYINT(1) NOT NULL, is_ongoing TINYINT(1) NOT NULL, is_closed TINYINT(1) NOT NULL, INDEX IDX_638A62C635B249 (franchisee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
