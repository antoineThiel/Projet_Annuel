 ...
 */
final class Version20200603123727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE franchisee_article CHANGE stock_product_id stock_product_id INT DEFAULT NULL, CHANGE stock_dish_id stock_dish_id INT DEFAULT NULL, CHANGE unit unit VARCHAR(10) DEFAULT NULL, CHANGE quantity quantity DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE franchisee_article CHANGE stock_product_id stock_product_id INT DEFAULT NULL, CHANGE stock_dish_id stock_dish_id INT DEFAULT NULL, CHANGE unit unit VARCHAR(10) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE quantity quantity DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE loyalty_card CHANGE newest_order newest_order DATE DEFAULT \'NULL\'');
