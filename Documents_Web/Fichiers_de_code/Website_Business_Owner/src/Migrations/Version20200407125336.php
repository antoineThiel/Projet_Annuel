 ...
 */
final class Version20200407125336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE order_by_franchisee (id INT AUTO_INCREMENT NOT NULL, warehouse_id INT DEFAULT NULL, date DATETIME NOT NULL, ammount DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_4990DEF65080ECDE (warehouse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
